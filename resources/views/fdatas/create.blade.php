...
<body class="bg-light">
    <div class="container">
        <div class="py-5 text-center">
            ...
            <p class="lead text-white bg-info">Hello! {{$student->name}}</p>
            @endisset
            <p class="lead text-white bg-primary ">Fill below Form to get login.</p>
        </div>
                ...
                <form method="post" action='{{route('fdatas.store')}}' class="needs-validation" novalidate>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="first_name" id="firstName" maxlength="10" placeholder="" value="" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="last_name" id="lastName" maxlength="12" placeholder="" value="" required>
                            <div class="invalid-feedback">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="email" class="form-control" name="email" id="email" placeholder="you@example.com" maxlength="50" value="" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="post" id="lastName" placeholder="" value="" required>
                            <div class="invalid-feedback">
                                post is required.
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control" name="dob" id="lastName" placeholder="" value="" required>
                            <div class="invalid-feedback">
                    ...
                    <div class='row'>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="fathers_name" id="firstName" placeholder="" value="" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="fathers_occupation" id="lastName" placeholder="" value="" required>
                            <div class="invalid-feedback">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" name="mobile" id="mobile" minlength="10" maxlength="10" placeholder="" value="" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" name="f_mobile" id="f_mobile" minlength="10" maxlength="10" placeholder="" value="" required>
                            <div class="invalid-feedback">
                                Valid mobile no. is required.
                            </div>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="address" id="address" minlength="10" maxlength="75" placeholder="1234 Main St" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="number" class="form-control" name="pincode" id="pincode" placeholder="" required>
                            <div class="invalid-feedback">
                                pin code required.
                            </div>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="about_us" id="exampleFormControlTextarea1" rows="3"  maxlength="250" ></textarea>
                        <div class="invalid-feedback">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="what_mn" id="exampleFormControlTextarea1" rows="3"   maxlength="250" ></textarea>
                        <div class="invalid-feedback">
                            min. 50 max 250 *requried.
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="why_mn" id="exampleFormControlTextarea1" rows="3"  maxlength="250" ></textarea>
                        <div class="invalid-feedback">
                            min. 50 max 250 *requried.
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="rel_mn" id="exampleFormControlTextarea1"  maxlength="50" rows="1"></textarea>
                        <div class="invalid-feedback">
                            optional.
                        </div>
                    </div>
                    ...
                    <div class="custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label" for="same-address">I hereby declare that the information given in this application is true and
                    ...
                    <div class="custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label" for="same-address2">I also declare that if any information provided by me is found false, my
